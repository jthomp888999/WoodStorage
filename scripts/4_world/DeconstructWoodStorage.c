class DeconstructWoodStorage extends RecipeBase
{
	override void Init()
	{
		m_Name = "Take Apart Wood Storage";
		...
		//ingredient 2
		InsertIngredient(1,"WoodStorage");//you can insert multiple ingredients this way
